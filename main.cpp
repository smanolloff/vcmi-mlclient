...
#include "user_agents/agent-v11.h"
...
namespace ML {
    ...
    InitArgs parse_args(int argc, char * argv[]) {
        ...
        if (leftAi == AI_MMAI_USER) {
            leftModel = new UserAgents::AgentV11(benchmark, interactive, autorender, false, recordings);
        ...
        if (rightAi == AI_MMAI_USER) {
            rightModel = new UserAgents::AgentV11(benchmark, interactive, autorender, false, recordings);
