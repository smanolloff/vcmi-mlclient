...
#include "user_agents/agent-v10.h"
...
namespace ML {
    ...
    InitArgs parse_args(int argc, char * argv[]) {
        ...
        if (leftAi == AI_MMAI_USER) {
            leftModel = new UserAgents::AgentV10(benchmark, interactive, autorender, false, recordings);
        ...
        if (rightAi == AI_MMAI_USER) {
            rightModel = new UserAgents::AgentV10(benchmark, interactive, autorender, false, recordings);
