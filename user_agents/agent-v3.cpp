...
namespace ML {
    namespace UserAgents {
        std::string AgentV3::getName() { return "UserAgent (v3)"; };
        int AgentV3::getVersion() { return 3; };
        double AgentV3::getValue(const MMAI::Schema::IState * s) { return -666; };
        ...
        MMAI::Schema::Action AgentV3::getAction(const MMAI::Schema::IState * s) {
            ...
            auto err = MMAI::Schema::AnyCastError(any, typeid(const MMAI::Schema::V3::ISupplementaryData*));
