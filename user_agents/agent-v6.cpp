...
#include "AI/MMAI/schema/v6/types.h"
#include "AI/MMAI/schema/v6/constants.h"

namespace ML {
    namespace UserAgents {
        std::string AgentV6::getName() { return "UserAgent (v6)"; };
        int AgentV6::getVersion() { return 6; };
        double AgentV6::getValue(const MMAI::Schema::IState * s) { return -666; };

        MMAI::Schema::Action AgentV6::getAction(const MMAI::Schema::IState * s) {
            MMAI::Schema::Action act;

            if (s->version() != 6)
                throw std::runtime_error("Expected version 6, got: " + std::to_string(s->version()));
            ...
            auto sup = std::any_cast<const MMAI::Schema::V6::ISupplementaryData*>(any);
            ...
            if (sup->getType() == MMAI::Schema::V6::ISupplementaryData::Type::ANSI_RENDER) {
        ...
        MMAI::Schema::Action AgentV6::promptAction(const MMAI::Schema::ActionMask &mask) {
            int num;
        ...
        MMAI::Schema::Action AgentV6::recordedAction() {
        ...
        MMAI::Schema::Action AgentV6::randomValidAction(const MMAI::Schema::ActionMask &mask) {
        ...
        MMAI::Schema::Action AgentV6::firstValidAction(const MMAI::Schema::ActionMask &mask) {
            for (int j = 1; j < mask.size(); j++)
                if (mask[j]) return j;
