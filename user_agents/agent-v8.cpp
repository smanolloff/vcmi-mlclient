...
#include "AI/MMAI/schema/v8/types.h"

namespace ML {
    namespace UserAgents {
        std::string AgentV8::getName() { return "UserAgent (v8)"; };
        int AgentV8::getVersion() { return 8; };
        double AgentV8::getValue(const MMAI::Schema::IState * s) { return -666; };

        MMAI::Schema::Action AgentV8::getAction(const MMAI::Schema::IState * s) {
            MMAI::Schema::Action act;

            if (s->version() != 8)
                throw std::runtime_error("Expected version 8, got: " + std::to_string(s->version()));
            ...
            auto sup = std::any_cast<const MMAI::Schema::V8::ISupplementaryData*>(any);
        ...
        MMAI::Schema::Action AgentV8::promptAction(const MMAI::Schema::ActionMask* mask) {
            int num;
        ...
        MMAI::Schema::Action AgentV8::recordedAction() {
        ...
        MMAI::Schema::Action AgentV8::randomValidAction(const MMAI::Schema::ActionMask* mask) {
        ...
        MMAI::Schema::Action AgentV8::firstValidAction(const MMAI::Schema::ActionMask* mask) {
            for (int j = 1; j < mask->size(); j++)
                if ((*mask)[j]) return j;
