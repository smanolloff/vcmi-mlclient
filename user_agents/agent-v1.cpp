...
namespace ML {
    namespace UserAgents {
        std::string AgentV1::getName() { return "UserAgent (v1)"; };
        int AgentV1::getVersion() { return 1; };
        double AgentV1::getValue(const MMAI::Schema::IState * s) { return -666; };
        ...
        MMAI::Schema::Action AgentV1::getAction(const MMAI::Schema::IState * s) {
            ...
            auto err = MMAI::Schema::AnyCastError(any, typeid(const MMAI::Schema::V1::ISupplementaryData*));
