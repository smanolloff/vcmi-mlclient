...
namespace ML {
    namespace UserAgents {
        ...
        private:
            ...
            MMAI::Schema::Action promptAction(const MMAI::Schema::ActionMask &mask, const MMAI::Schema::IState * s);
            MMAI::Schema::Action recordedAction();
            MMAI::Schema::Action randomValidAction(const MMAI::Schema::ActionMask &mask, const MMAI::Schema::IState * s);
