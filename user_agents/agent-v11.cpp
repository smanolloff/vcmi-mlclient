...
#include "AI/MMAI/schema/v11/types.h"

namespace ML {
    namespace UserAgents {
        std::string AgentV11::getName() { return "UserAgent (v11)"; };
        int AgentV11::getVersion() { return 11; };
        double AgentV11::getValue(const MMAI::Schema::IState * s) { return -666; };

        MMAI::Schema::Action AgentV11::getAction(const MMAI::Schema::IState * s) {
            MMAI::Schema::Action act;

            if (s->version() != 11)
                throw std::runtime_error("Expected version 11, got: " + std::to_string(s->version()));
            ...
            auto sup = std::any_cast<const MMAI::Schema::V11::ISupplementaryData*>(any);
            ...
            if (sup->getType() == MMAI::Schema::V11::ISupplementaryData::Type::ANSI_RENDER) {
        ...
        MMAI::Schema::Action AgentV11::promptAction(const MMAI::Schema::ActionMask* mask) {
            int num;
        ...
        MMAI::Schema::Action AgentV11::recordedAction() {
        ...
        MMAI::Schema::Action AgentV11::randomValidAction(const MMAI::Schema::ActionMask* mask) {
        ...
        MMAI::Schema::Action AgentV11::firstValidAction(const MMAI::Schema::ActionMask* mask) {
            for (int j = 1; j < mask->size(); j++)
                if ((*mask)[j]) return j;
